...
(define (test-halfspace)
 (let* ((y<10 (make-halfspace #(0 1 0) #(0 10 0)))
        ...
        (y<5  (make-halfspace #(0 1 0) #(0 5 0)))
	(sphere (make-sphere #(0 5 0) 5))
	(hemisphere (make-intersection sphere y<5))
 ...
 (test "Intersect slab from under it"
  (near-equal?
   ...
   (list #(1 5 1) #(0 -1 0))))
 (test "Intersect slab II from under it"
  (near-equal?
   (intersect ybetween5and10-II #(1 -100 1) #(0 1 0))
   (list #(1 5 1) #(0 -1 0))))
 ...
 (test "All-intersections 2"
   (near-equal? 
    ...
    '((#(0 10 0) #(0 1 0)) (#(0 5 0) #(0 -1 0)))))
 (test "All-intersections with hemisphere"
   (near-equal? 
    (all-intersections hemisphere #(0 100 0) #(0 -1 0))

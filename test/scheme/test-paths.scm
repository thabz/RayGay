...
(define (test-circle-path)
 ...
 (test "point1" (near-equal? (point-on-path c 0/4) #(10 0 0)))
 (test "point2" (near-equal? (point-on-path c 1/4) #(0 10 0)))
 (test "point3" (near-equal? (point-on-path c 2/4) #(-10 0 0)))
 (test "point4" (near-equal? (point-on-path c 3/4) #(0 -10 0)))
 )

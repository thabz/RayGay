...
CounterStats *ShadowCache::shadow_rays_cast =
    new CounterStats("Lights", "Shadow rays cast");
CounterStats *ShadowCache::shadow_cache_hint_hit =
    new CounterStats("Lights", "Shadow cache hint hit");
...
bool ShadowCache::occluded(const Ray &ray_to_light, const double dist_to_light,
                           uint32_t depth, KdTree *space,
                           const Object *ignore) {

...
WhittedAdaptive::WhittedAdaptive(Image *image, Renderer *renderer,
                                 uint32_t aa_depth)
 ...
 */
void WhittedAdaptive::prepareCurRow(std::vector<PixelBlock> *cur_row,
 ...
 * cur_block
 */
void WhittedAdaptive::prepareCurBlock(PixelBlock *cur_block,
                                      PixelBlock *prev_block,
                                      uint32_t blocksize) {
...
RGBA WhittedAdaptive::getSubPixel(uint32_t curLevel, const Vector2 &center,
...
inline void WhittedAdaptive::PixelBlock::reset() {
...
Sampler *WhittedAdaptiveFactory::createInstance(Image *img,
                                                Renderer *renderer) {

...
void R6RSLibUnicode::bind(Scheme *scheme, SchemeObject *envt) {
  ...
  scheme->assign(L"string-downcase", 1, 0, 0,
                 (SchemeObject * (*)()) s_string_downcase, envt);
  scheme->assign(L"string-upcase", 1, 0, 0,
                 (SchemeObject * (*)()) s_string_upcase, envt);
  scheme->assign(L"char-general-category", 1, 0, 0,
                 (SchemeObject * (*)()) s_char_general_category, envt);
}

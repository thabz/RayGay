...
void test_char() {
    ...
    assert_eval(s, "(char>? #\\4 #\\3 #\\1)", "#t");
    assert_eval(s, "(char>? #\\b #\\a #\\a)", "#f");
    assert_eval(s, "(char>? #\\c #\\b #\\a)", "#t");
    assert_eval(s, "(char<=? #\\a #\\b #\\d)", "#t");
    assert_eval(s, "(char<=? #\\a #\\b #\\b)", "#t");
    assert_eval(s, "(char<=? #\\d #\\b #\\c)", "#f");
...
void test_string() {
    ...
    assert_eval(s, "(string>? \"aab\" \"aa\")", "#t");
    assert_eval(s, "(string>? \"aaa\" \"aa\" \"a\")", "#t");
    assert_eval(s, "(string>? \"aaa\" \"a\" \"aa\")", "#f");
    assert_eval(s, "(string<? \"a\" \"aa\" \"aaa\")", "#t");
    assert_eval(s, "(string<? \"a\" \"aaa\" \"aa\")", "#f");
    assert_eval(s, "(string>? \"a\" \"az\")", "#f");
    ...
    assert_eval(s, "(string-ci>=? \"aBcdEF\"  \"abcDEF\"  \"aBcded\")", "#t");
...
void test_bigint() {
    BigInt b = BigInt("152415787806736785156226207501905212132132131312321321322222222222222222222222222222222222152415787806736785156226207501905212132132131312321321322222222222222222222222222222222222");
    b.dump();    
    return;
    ...
    assert(BigInt("999999999999999999999999999999999") <= BigInt("999999999999999999999999999999999"));
    assert(BigInt("999999999999999999999999999999999") <= BigInt("9999999999999999999999999999999999"));
}

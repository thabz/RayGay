...
class Syntax 
{
    ...
    private:
        static bool matches(SchemeObject* literals, SchemeObject* pattern, SchemeObject* input);
        static SchemeObject* transform(SchemeObject* pattern, SchemeObject* templat, SchemeObject* input);
};

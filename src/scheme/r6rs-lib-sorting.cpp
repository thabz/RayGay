...
void merge(Scheme* scheme, SchemeObject* proc,
...
void mergesort(Scheme* scheme, SchemeObject* proc, SchemeObject** array, int32_t size, SchemeObject** tmp) {
    if (size <= 1) return;
...
SchemeObject* s_vector_sort_e(Scheme* scheme, SchemeObject* proc, SchemeObject* vec) {
...
SchemeObject* s_list_sort(Scheme* scheme, SchemeObject* proc, SchemeObject* list) {
...
SchemeObject* s_vector_sort(Scheme* scheme, SchemeObject* proc, SchemeObject* vec) {

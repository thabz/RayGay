...
SchemeObject* s_make_hashtable(Scheme* scheme, SchemeObject* hash_func, SchemeObject* equiv_func, SchemeObject* k) {
    if (k != S_UNSPECIFIED) {
...
SchemeObject* s_hashtable_clear_e(Scheme* scheme, SchemeObject* hashtable, SchemeObject* k) {
...
SchemeObject* s_hashtable_set_e(Scheme* scheme, SchemeObject* hashtable, SchemeObject* key, SchemeObject* obj) {
...
SchemeObject* s_hashtable_ref(Scheme* scheme, SchemeObject* hashtable, SchemeObject* key, SchemeObject* defaul) {
...
SchemeObject* s_hashtable_update_e(Scheme* scheme, SchemeObject* hashtable, SchemeObject* key, SchemeObject* proc, SchemeObject* defaul) {
...
SchemeObject* s_hashtable_delete_e(Scheme* scheme, SchemeObject* hashtable, SchemeObject* key) {
...
SchemeObject* s_hashtable_contains_p(Scheme* scheme, SchemeObject* hashtable, SchemeObject* key) {
...
SchemeObject* s_hashtable_copy(Scheme* scheme, SchemeObject* hashtable, SchemeObject* mutab) {
    ...
    SchemeObject* copy = s_make_hashtable(scheme, hash_func, equiv_func, int2scm(buckets->length));
...
SchemeObject* s_hashtable_equivalence_function(Scheme* scheme, SchemeObject* hashtable) {
    assert_arg_hashtable_type(L"hashtable-equivalence-function", 1, hashtable);
    return i_cadr(hashtable->s_hashtable_meta);
}

SchemeObject* s_hashtable_hash_function(Scheme* scheme, SchemeObject* hashtable) {

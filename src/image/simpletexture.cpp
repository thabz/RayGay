 ...
 */
SimpleTexture::SimpleTexture(Image *image, const Vector2 &repeat_uv,
 ...
 */
SimpleTexture::~SimpleTexture() { delete image; }
...
RGBA SimpleTexture::getRGB(int x, int y) const { return image->getRGBA(x, y); }

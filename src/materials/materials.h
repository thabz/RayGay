...
#define MATERIAL_DULL_RED Material(RGB(1.0,0.2,0.2),1.00,RGB(1.0,1.0,1.0),0.0,30)
#define MATERIAL_DULL_BLUE Material(RGB(0.2,0.2,1.0),1.00,RGB(1.0,1.0,1.0),0.0,30)
#define MATERIAL_DULL_GRAY Material(RGB(0.8,0.8,0.8),0.75,RGB(1.0,1.0,1.0),0.0,30)

 ...
 * estimate
 */
GlobalPhotonMap::GlobalPhotonMap(const int size, double max_dist,
                                 int estimate_photons)
    : PhotonMap<IrradiancePhoton>(size, max_dist, estimate_photons) {}
 ...
 */
void GlobalPhotonMap::store(const RGB &power, const Vector &pos,
 ...
 */
RGB GlobalPhotonMap::directIrradianceEstimate(const Vector &pos,
 ...
 * @param normal The surface normal at that point.
 */
RGB GlobalPhotonMap::irradianceEstimate(const Vector &pos,
                                        const Vector &normal) const {
...
void GlobalPhotonMap::locate_photon(locatePhotonArgs *const args,

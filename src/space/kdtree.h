 ...
 * k-dimensional tree.
 *
 * Implementerer http://www.acm.org/jgt/papers/HavranKopalBittnerZara97/ som er
 * den bedste BSP-traversal algoritme.
 *
...
public:
  ...
  Object *intersectForShadow(const Ray &ray, double max_t,
...
private:
  ...
  bool intersect(const Ray &ray, Intersection &result, const double a,
                 const double b) const;
  double intersect(const Ray &ray, const double a, const double b) const;
  Object *intersectForShadow_real(const Ray &, const double,

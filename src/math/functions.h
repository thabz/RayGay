...
public:
  ...
  /// Solves quartic equation
  static int solveQuarticSingle(double A, double B, double C, double D,
                                double cut, double *root);

  /// Solves quartic equation (invalid)
  static int solveQuartic_Schaum(double A, double B, double C, double D,
                                 double *roots);

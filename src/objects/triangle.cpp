...
const Material *Triangle::getMaterial() const { return mesh->getMaterial(); }
...
// ----------------------------------------------------------------------------
void Triangle::_fullIntersect(const Ray &ray, const double t2,
...
int triBoxOverlap(const Vector &boxcenter, const Vector &boxhalfsize,
                  Vector triverts[3]) {

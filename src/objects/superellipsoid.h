 ...
 *
 * \f[ f(x,y,z) = \left( |x|^{2/n_2} + |y|^{2/n_2} \right)^{n_2 / n_1} +
 * |z|^{2/n_1} \f] The surface is \f$ f(x,y,z) = 1 \f$ and the interior is \f$
 * f(x,y,z) < 1 \f$
 *
...
public:
  /// Constructor
  SuperEllipsoid(double n1, double n2, uint32_t steps, double accuracy,
                 Material *m);

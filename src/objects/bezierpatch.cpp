 ...
 */
BezierPatch::BezierPatch(const vector<Vector> &points, const uint xResolution, const uint yResolution, const Material* material) : Mesh(Mesh::MESH_PHONG,material) {

 ...
 */
BezierPatch::BezierPatch(const vector<Vector> &points,
                         const uint32_t uResolution, const uint32_t vResolution,
                         const Material *material)
    : ParametrizedSurface(uResolution, vResolution, false, false, material) {

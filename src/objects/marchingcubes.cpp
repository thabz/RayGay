...
void MarchingCubes::handleCube(const Vector& min, const Vector& max) {
    ...
    cubeindex |= inside(cubeverts[0]) << 0;
    cubeindex |= inside(cubeverts[1]) << 1;
    cubeindex |= inside(cubeverts[2]) << 2;
    cubeindex |= inside(cubeverts[3]) << 3;
    cubeindex |= inside(cubeverts[4]) << 4;
    cubeindex |= inside(cubeverts[5]) << 5;
    cubeindex |= inside(cubeverts[6]) << 6;
    cubeindex |= inside(cubeverts[7]) << 7;

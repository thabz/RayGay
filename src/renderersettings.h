...
public:
  ...
  enum RendererType { PHOTON_RENDERER, RAYTRACER, PATHTRACER, NONE };
  ...
  /// The maximum number of photons to consider when doing an irrandiance
  /// estimate from the photonmaps

...
public:
  static SchemeObject *make_texture(Scheme *scheme, SchemeObject *s_filename,
                                    SchemeObject *s_repeat_x,
                                    SchemeObject *s_repeat_y,
                                    SchemeObject *s_interpolation_type);
  static SchemeObject *make_multi_texture(
  ...
  static SchemeObject *get_pixel(Scheme *scheme, SchemeObject *s_texture,

 ...
 */
SchemeObject *PathFactory::make_circle(Scheme *scheme, SchemeObject *s_center,
 ...
 */
SchemeObject *PathFactory::make_ellipse(Scheme *scheme, SchemeObject *s_center,
                                        SchemeObject *s_radius1,
                                        SchemeObject *s_radius2,
                                        SchemeObject *s_normal) {
 ...
 */
SchemeObject *PathFactory::make_linesegment(Scheme *scheme,
                                            SchemeObject *s_from,
                                            SchemeObject *s_to) {
 ...
 */
SchemeObject *PathFactory::make_spiral(Scheme *scheme, SchemeObject *s_path,
                                       SchemeObject *s_radius,
...
SchemeObject *PathFactory::make_bezierspline(Scheme *scheme,
                                             SchemeObject *s_vector_vector) {
  vector<Vector> vectors =
      scm2vectorlist(s_vector_vector, L"make-bezierspline", 1);
  return path2scm(new BezierSpline(vectors));
}

SchemeObject *
PathFactory::make_catmullrom_spline(Scheme *scheme,
                                    SchemeObject *s_vector_vector) {
  vector<Vector> vectors =
      scm2vectorlist(s_vector_vector, L"make-catmullrom-spline", 1);
 ...
 */
SchemeObject *PathFactory::point_on_path(Scheme *scheme, SchemeObject *s_path,
                                         SchemeObject *s_t) {
 ...
 */
SchemeObject *PathFactory::tangent_to_path(Scheme *scheme, SchemeObject *s_path,
                                           SchemeObject *s_t) {
...
void PathFactory::register_procs(Scheme *scheme) {
  scheme->assign(L"make-circle", 3, 0, 0,
                 (SchemeObject * (*)()) PathFactory::make_circle);
  scheme->assign(L"make-ellipse", 4, 0, 0,
                 (SchemeObject * (*)()) PathFactory::make_ellipse);
  scheme->assign(L"make-linesegment", 2, 0, 0,
                 (SchemeObject * (*)()) PathFactory::make_linesegment);
  scheme->assign(L"make-spiral", 4, 0, 0,
                 (SchemeObject * (*)()) PathFactory::make_spiral);
  scheme->assign(L"make-bezierspline", 1, 0, 0,
                 (SchemeObject * (*)()) PathFactory::make_bezierspline);
  scheme->assign(L"make-catmullrom-spline", 1, 0, 0,
                 (SchemeObject * (*)()) PathFactory::make_catmullrom_spline);

...
class ImageFactory {
public:
  static SchemeObject *make_image(Scheme *scheme, SchemeObject *width,
                                  SchemeObject *height, SchemeObject *bg_color);
  ...
  static SchemeObject *save_image(Scheme *scheme, SchemeObject *s_image,
  ...
  static SchemeObject *set_alpha_combine_mode(Scheme *scheme,
                                              SchemeObject *s_mode);
  static SchemeObject *set_pixel(Scheme *scheme, SchemeObject *s_image,
                                 SchemeObject *s_x, SchemeObject *s_y,
                                 SchemeObject *color);
  static SchemeObject *get_pixel(Scheme *scheme, SchemeObject *s_image,
                                 SchemeObject *s_x, SchemeObject *s_y);
  static SchemeObject *draw_line(Scheme *scheme, SchemeObject *s_image,
                                 SchemeObject *s_from, SchemeObject *s_to,
                                 SchemeObject *color);
  static SchemeObject *draw_filled_box(Scheme *scheme, SchemeObject *s_image,
                                       SchemeObject *s_pos,
                                       SchemeObject *s_size,
                                       SchemeObject *color);
  static SchemeObject *draw_circle(Scheme *scheme, SchemeObject *s_image,
                                   SchemeObject *s_center,
                                   SchemeObject *s_radius, SchemeObject *color);
  static SchemeObject *draw_filled_circle(Scheme *scheme, SchemeObject *s_image,
                                          SchemeObject *s_center,
                                          SchemeObject *s_radius,
                                          SchemeObject *color);
  static SchemeObject *draw_string(Scheme *scheme, SchemeObject *s_image,
                                   SchemeObject *s_center, SchemeObject *s_text,
                                   SchemeObject *s_size,
                                   SchemeObject *s_ttf_file,
                                   SchemeObject *s_color);
  static SchemeObject *apply_gaussian_blur(Scheme *scheme,

...
SCM make_skylight(SCM s_radius, SCM s_num) {
...
void LightsourceFactory::register_procs() {
    scm_c_define_gsubr("make-pointlight",1,0,0,(SCM (*)()) make_pointlight);
    scm_c_define_gsubr("make-arealight",5,0,0,(SCM (*)()) make_arealight);
    scm_c_define_gsubr("make-spotlight",4,1,0,(SCM (*)()) make_spotlight);
    scm_c_define_gsubr("make-skylight",2,0,0,(SCM (*)()) make_skylight);
}
